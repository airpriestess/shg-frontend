    ...
    <div style={{ height: "100%", overflowY: "auto", background: "linear-gradient(160deg,#fef0f8 0%,#fde4f0 30%,#f8eafc 60%,#fef0ec 100%)", color: "#0a0a0a" }} className="mob-pb">
      <div style={{ maxWidth: 880, margin: "0 auto", padding: "28px 24px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 28 }}>
          <div>
            <div className="wm" style={{ fontSize: 16, color: "#2CB7A7", fontWeight: 500, letterSpacing: "0.04em", marginBottom: 6, }}>ProofOS</div>
            <h1 className="wm" style={{ fontSize: "clamp(32px,4vw,48px)", fontWeight: 600, margin: 0, lineHeight: 1.1, background: "linear-gradient(90deg,#F5E0A0 0%,#E8B870 22%,#BFA5D8 52%,#2CB7A7 78%,#167A6B 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              {USER.name}'s Vault
            </h1>
          </div>

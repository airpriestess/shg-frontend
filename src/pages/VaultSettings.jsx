...
export default function VaultSettings({ userTier, onSignOut, onUpgrade }) {
  ...
  const planLabel = userTier === "founder" ? "Founder · Lifetime" : userTier === "goddess" ? "Goddess Tier · $42/month" : "Audio Tier · $24/month";
  ...
  return (
    <div style={{ padding: "28px 24px", overflowY: "auto", height: "100%", maxWidth: 660, margin: "0 auto" }} className="mob-pb fade">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {/* ── UPGRADE ── */}
        {userTier === "audio" && (
          <div style={{ background: "linear-gradient(135deg,#0f0d02,#000000)", border: `1px solid #2CB7A744`, borderRadius: 14, padding: "22px 22px", cursor: "pointer" }} onClick={onUpgrade}>

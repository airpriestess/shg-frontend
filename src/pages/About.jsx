    ...
    <div ref={topRef} style={{ minHeight:"100vh", background:BLACK, color:CREAM, fontFamily:"'Jost',sans-serif" }}>
      ...
      <div style={{ background:BLACK, padding: isMobile?"64px 24px":"80px 24px" }}>
        <div style={{ maxWidth:660, margin:"0 auto" }}>
          <p style={{ fontSize:11, letterSpacing:"0.22em", textTransform:"uppercase", color:"rgba(242,236,228,0.35)", marginBottom:36, textAlign:"center" }}>Where it started</p>
      ...
      <div style={{ background:CREAM, padding: isMobile?"64px 24px":"80px 24px" }}>
        <div style={{ maxWidth:660, margin:"0 auto" }}>
          <p style={{ fontSize:11, letterSpacing:"0.22em", textTransform:"uppercase", color:"rgba(0,0,0,0.35)", marginBottom:36, textAlign:"center" }}>The discovery</p>
      ...
      <div style={{ background:LG, padding: isMobile?"64px 24px":"80px 24px", textAlign:"center" }}>
        <div style={{ maxWidth:640, margin:"0 auto" }}>
          <p style={{ fontSize:11, letterSpacing:"0.22em", textTransform:"uppercase", color:"rgba(0,0,0,0.45)", marginBottom:32 }}>What I actually believe</p>
          <blockquote style={{ fontFamily:"'Cormorant Garamond',serif", fontStyle:"italic", fontSize: isMobile?"clamp(24px,6.5vw,36px)":"clamp(28px,3vw,44px)", color:BLACK, lineHeight:1.45, fontWeight:400, margin:"0 0 32px" }}>
            "I am delusional about everything. And I am proud of it."
          </blockquote>
      ...
      <div style={{ background:BLACK, padding: isMobile?"64px 24px":"80px 24px" }}>
        <div style={{ maxWidth:660, margin:"0 auto", textAlign:"center" }}>
          <p style={{ fontSize:11, letterSpacing:"0.22em", textTransform:"uppercase", color:"rgba(242,236,228,0.35)", marginBottom:28 }}>What's inside</p>
      ...
      <div style={{ background:LG, padding: isMobile?"64px 24px 80px":"80px 24px 100px", textAlign:"center" }}>
        <p style={{ fontSize:11, letterSpacing:"0.22em", textTransform:"uppercase", color:"rgba(0,0,0,0.45)", marginBottom:24 }}>Join the platform</p>

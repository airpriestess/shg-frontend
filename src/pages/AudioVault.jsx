...
const CAT_COLOR = {
  Money: "#C8892A", Beauty: "#B76E79", Love: "#B76E79",
  Identity: "#9a8060", Sleep: "#6a8ad0", Body: "#C8892A",
};
...
function AccessBadge({ audio, userTier }) {
  ...
  if (userTier === "founder") return <span style={{ fontSize: 10, padding: "2px 8px", background: "#C8892A22", border: "1px solid #C8892A44", borderRadius: 20, color: "#C8892A", fontWeight: 700 }}>Founder</span>;
  ...
  return <span style={{ fontSize: 10, padding: "2px 8px", background: "#C8892A18", border: "1px solid #C8892A33", borderRadius: 20, color: "#C8892A", fontWeight: 700 }}>Audio Tier</span>;
}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
          <div style={{ display: "flex", gap: 2, alignItems: "center" }}>
            {[6, 14, 20, 10, 16].map((h, j) => (
              <div key={j} style={{ width: 2, height: h, borderRadius: 1, background: "#C8892A", opacity: 0.8 }} />
            ))}
          </div>
          <span style={{ fontSize: 12, color: "#C8892A", fontWeight: 600 }}>Now playing</span>
        </div>
      )}
      ...
      <div>
        ...
        {linked.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {linked.map(t => {
              const statusColor = t.status === "Manifested" ? "#4a9a5a" : t.status === "Evidence Appearing" ? "#C8892A" : T.textMuted;
              return (

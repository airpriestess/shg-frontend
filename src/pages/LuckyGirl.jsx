...
const s = {
  ...
  tag: { display: "inline-block", fontSize: 10, letterSpacing: ".28em", textTransform: "uppercase", marginBottom: 28, background: LG, WebkitBackgroundClip: "text", backgroundClip: "text", color: "transparent" },
  ...
  sub: { fontSize: 15, color: "#7a6e68", lineHeight: 1.7, maxWidth: 400, margin: "20px auto 40px" },
  emailWrap: { maxWidth: 400, margin: "0 auto", padding: "0 24px" },

...
const THEMES = {
  ...
  light: { bg:"linear-gradient(135deg,#F5E0A0 0%,#E8B870 14%,#BFA5D8 34%,#2CB7A7 62%,#167A6B 100%)", bg2:"rgba(255,255,255,0.25)", bg3:"rgba(255,255,255,0.35)", nav:"rgba(245,224,160,0.55)", cr:"#000000", mu:"#000000", dim:"#000000", border:"rgba(255,255,255,0.45)", inputBg:"rgba(255,255,255,0.55)" },
};

  ...
  return (
    <div style={{ background:C.card, borderRadius:16, padding:compact?"12px 14px":"20px 18px", border:`1px solid ${C.border}`, fontFamily:"'Jost',sans-serif" }}>
      ...
      <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:14 }}>
        <span style={{ fontSize:13*fs, fontWeight:400, color:R, letterSpacing:"0.15em", textTransform:"uppercase" }}>Your analytics ✦</span>
        <span style={{ fontSize:11*fs, fontWeight:400, padding:"4px 12px", background:OMBRE, backgroundSize:"200%", backgroundPosition:"left", borderRadius:20, color:BLACK, animation:"abFlash 2.2s ease-in-out infinite" }}>{streakDays}-day streak</span>
      </div>
      <div style={{ fontSize:14*fs, fontWeight:400, color:C.text, marginBottom:14 }}>{manifested} of {total} intentions manifested <span style={{ color:R }}>✦</span></div>

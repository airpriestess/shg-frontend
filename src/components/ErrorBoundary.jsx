...
export default class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ minHeight:"100vh", background:"linear-gradient(135deg,#F5E0A0,#E8B870,#BFA5D8,#2CB7A7,#167A6B)", display:"flex", alignItems:"center", justifyContent:"center", padding:24, fontFamily:"'Jost',sans-serif" }}>
          <div style={{ maxWidth:440, background:"#0a0a0a", borderRadius:20, padding:"32px 28px", textAlign:"center", boxShadow:"0 20px 60px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ fontSize:18, fontWeight:800, color:"#fdf0e8", marginBottom:14, fontFamily:"'Jost',sans-serif" }}>Dashboard hit a snag loading.</div>
            <div style={{ fontSize:13, color:"rgba(253,240,232,0.7)", lineHeight:1.7, marginBottom:20 }}>Usually a stale cached file. Try one of these, in order, and tell Reshma if none work.</div>
            ...
            {this.state.err && <details style={{ marginTop:10, textAlign:"left", fontSize:10, color:"rgba(253,240,232,0.7)", background:"#000000", padding:"8px 10px", borderRadius:8 }}>

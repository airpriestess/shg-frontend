...
export default class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ minHeight:"100vh", background:"linear-gradient(135deg,#f5e0a0 0%,#e8b870 25%,#d4a090 55%,#c4789a 80%,#B76E79 100%)", display:"flex", alignItems:"center", justifyContent:"center", padding:24, fontFamily:"'Jost',sans-serif" }}>
          <div style={{ maxWidth:440, background:"#fff8f4", borderRadius:20, padding:"32px 28px", textAlign:"center", boxShadow:"0 20px 60px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ fontSize:11, fontWeight:900, color:"#B76E79", letterSpacing:"0.22em", textTransform:"uppercase", marginBottom:10 }}>Something interrupted the shift</div>
            ...
            <div style={{ display:"flex", flexDirection:"column", gap:8, marginBottom:16 }}>
              <button onClick={()=>{ window.location.reload(); }} style={{ padding:"12px", background:"linear-gradient(90deg,#e8b870,#B76E79)", border:"none", borderRadius:10, color:"#000", fontSize:14, fontWeight:800, cursor:"pointer", fontFamily:"'Jost',sans-serif" }}>Reload</button>

...
{ k:"emdr", icon:"⇄", title:"What is EMDR?",
  ...
  { k:"binaural", icon:"◉", title:"What are binaural beats?",
    body:"Binaural beats are an auditory illusion that your brain creates when it hears two slightly different frequencies — one in each ear. If your left ear hears 200 Hz and your right ear hears 210 Hz, your brain generates a third tone at the difference: 10 Hz. That 10 Hz tone is in the alpha brainwave range, and your brain begins to synchronise to it.\n\nThis process is called brainwave entrainment. By playing the right frequency difference, binaural beats can guide your brain from beta (awake, thinking) down into alpha, theta, or delta — the receptive states where new identity installs.\n\nSHG tracks use binaural beats tuned to theta (4–8 Hz difference) so your brain is pulled into the ideal installation state automatically, without you having to meditate or try to relax.\n\nHeadphones are required. Without headphones, each ear hears both frequencies and the third tone your brain generates disappears." },

  { k:"hawkins-how", icon:"↑", title:"How to actually use the Hawkins scale",
    body:"Before you log a new desire in ProofOS, pause and check in with yourself honestly. Not how you want to feel — how you actually feel, right now, in your body.\n\nFind the Hawkins level that matches your genuine state. You don't need to be precise — a rough match is enough. Log it in the emotion tracker.\n\nThen listen to your audio.\n\nAfter seven days, check in again. Log your current state. Over time, your Analytics tab shows the average — and that average is your actual point of attraction. Not your mood today. Your dominant operating frequency.\n\nThe practical use: if you're manifesting from Fear (100) or Desire (125), the audio is doing the heavy lifting of pulling you up. If you're logging from Courage (200) or above, your manifestations move faster because you're already in expansive energy.\n\nYou cannot fake the scale into giving you a better result. Log honestly. The shift happens through the audios, not through pretending." },

    ...
    <div id="pricing" style={{ padding: isMobile ? "56px 18px" : "80px 24px", background: "#000", width: "100%", scrollMarginTop: isMobile ? 24 : 0 }}>
      <div style={{ maxWidth: 1040, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr 1fr", gap: isMobile ? 28 : 16, overflow: "visible" }}>
          {cards.map(c => (
            <div key={c.id} style={{ background: c.bg, border: `${c.popular ? "2px" : "1px"} solid ${c.border}`, borderRadius: 20, padding: c.popular ? (isMobile ? "44px 20px 28px" : "40px 24px 28px") : "28px 20px", marginTop: isMobile ? (c.popular ? 28 : 0) : (c.popular ? -12 : 0), position: "relative", overflow: "visible", boxShadow: c.popular ? "0 0 40px rgba(44,183,167,0.2)" : "none" }}>
    ...
    <div className="hypno-bg" style={{ background: "#000000", minHeight: "100vh" }}>
      ...
      <div id="proofos" style={{ background:"#000", padding: isMobile?"64px 24px 56px":"88px 80px 72px", width:"100%", textAlign:"center" }}>
        <div style={{ maxWidth:680, margin:"0 auto" }}>
          ...
          <div style={{ fontSize: isMobile?15:17, color:"#f2ece4", fontFamily:"'Jost',sans-serif", marginBottom:8 }}>And then it goes to the Proof Wall. ↓</div>
        </div>
      </div>
      ...
      <div style={{ background: "#000", padding: isMobile?"64px 24px":"80px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: isMobile?16:19, color: "#e8e0d8", marginBottom: 32, lineHeight: 1.75, maxWidth: 420, margin: "0 auto 32px", fontFamily: "'Jost',sans-serif" }}>
            Be the first to know when the audio library opens.
          </p>

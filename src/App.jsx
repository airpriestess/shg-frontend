        ...
        <div style={{ height: `calc(100vh - ${isMobile?"98px":"102px"} - env(safe-area-inset-top,0px))`, minHeight: isMobile?480:560, display:"flex", flexDirection:"column", background:"#000" }}>
          <div style={{ flex:1, display:"flex", flexDirection:"column", justifyContent:"center" }}>
            <IdentityCarousel cats={[
              ...
              { label:"Facemaxxing",       tagline:"My face is getting better every day." },
              { label:"Bodymaxxing",       tagline:"My body is a gift I keep unwrapping." },
              { label:"Lovemaxxing",       tagline:"He thinks about me. He can't help it." },
              { label:"Selfmaxxing",       tagline:"I am the main character. Obviously." },
              { label:"Erosmaxxing",       tagline:"I am irresistible. Obviously." },
              { label:"Businessmaxxing",   tagline:"Money finds me first." },
              { label:"Singlemaxxing",     tagline:"I am whole. I am enough. I am it." },
              { label:"Skinnymaxxing",     tagline:"My body knows exactly what it's doing." },
              ...
              { label:"Beautymaxxing",     tagline:"People stare. I understand." },
              { label:"Lifemaxxing",       tagline:"My highest self is my only self." },
              { label:"Lovemaxxing",       tagline:"My person finds their way back. Always." },
              { label:"Facemaxxing",       tagline:"My glow is undeniable." },
              { label:"Selfmaxxing",       tagline:"I became her. She was always me." },
              { label:"Bodymaxxing",       tagline:"I am slim, toned, and radiant." },
              { label:"Businessmaxxing",   tagline:"My income is embarrassing. In the best way." },
              { label:"Erosmaxxing",       tagline:"My energy is magnetic. People feel it." },
              { label:"Singlemaxxing",     tagline:"I am so full I don't need anyone to complete me." },
              { label:"Moneymaxxing",      tagline:"I make money in my sleep." },
              { label:"DNAmaxxing",        tagline:"My bloodline is activated." },
              { label:"Skinnymaxxing",     tagline:"My metabolism works for me, not against me." },
